<x-form-section submit="updateProfileInformation">
    <x-slot name="form">
        ...
        <!--Identity-->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="identity" value="Identity" />
            <x-input id="identity" type="text" class="block w-full mt-1" wire:model.defer="state.identity" />
            <x-input-error for="identity" class="mt-2" />
        </div>
        <!--Address-->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="address" value="Address" />
            <x-input id="adress" type="text" class="block w-full mt-1" wire:model.defer="state.address" />
