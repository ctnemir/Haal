...
<header class="py-4 bg-white shadow-md dark:bg-gray-800">
              ...
              <li class="relative">
                  ...
                  <template x-if="isProfileMenuOpen">
                      <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" @click.away="closeProfileMenu" @keydown.escape="closeProfileMenu" class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700" aria-label="submenu">
                          ...
                          <div class="hidden block px-4 py-2 text-xs text-gray-400">
                              {{ __('Manage Team') }}
                          </div>
      ...
      <div
      id="alert-success"
      class="hidden w-full justify-center bg-green-300 dark:bg-green-800 p-1 flex"
      >
          <p class="flex font-bold text-green-800 dark:text-white "></p>
      </div>
    <div
        id="alert-abort"
        class="hidden w-full justify-center bg-red-300 dark:bg-red-800 p-1 flex"
    >
        <p class="flex font-bold text-red-800 dark:text-white "></p>
    </div>
  </header>
</template>
<template x-if="dark">
