                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-full" src="https://ui-avatars.com/api/?name={{urlencode($order->first()->kind->name)}}&color=7F9CF5&background=EBF4FF" alt="" loading="lazy" />
                                        <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                    </div>
                                    <div>
                                        <p class="font-semibold">{{$order->first()->kind->name}}</p>
...
{{--                                        </p>--}}
                            ...
                            <td class="px-4 py-3 text-xs">
                                @foreach($order->groupBy('seller') as $ord)
